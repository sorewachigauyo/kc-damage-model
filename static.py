vanguard_shelling = lambda position, shipcount: 1.0 if position >= int(shipcount / 2) else 0.5
vanguard_asw = lambda position, shipcount: 0.6 if position >= int(shipcount / 2) else 1
